    ...
    <div id="about" className="relative overflow-hidden">
      ...
      <div className="absolute top-30 right-0 left-0">
        <div className="text-center text-white md:text-2xl max-w-2xl mx-auto font-poppins px-5">
          ...
          <p className="mb-5">The United Republics of Mars is an Earth based corporation and the the only quasi official government body on Mars with a military arm to enforce its monopoly on inter-planetary transport.</p>
